...
from src.scrapers.stock_scraper import fetch_data as stock_scraper
from src.scrapers.crypto_scraper import run_scraper as crypto_scraper

from src.gcp.clean_data import clean_df, volume_as_int
from src.gcp.get_gcp import connect, get_data, save_gcp
